...
vb = pd.read_csv('Samsung Dialog (1).txt', sep = ':', header = None)
vb.head(10)
...
st.markdown("<h3 style = 'margin: -25px; color: #072541; text-align: center;font-family: Arial, Helvetica, sans-serif; '> CHATBOT BUILT BY CHUKWUDI ONOVO</h3>", unsafe_allow_html= True)


st.markdown("<br> <br>", unsafe_allow_html= True)
col1, col2 = st.columns(2)
col1.image('botig1.jpeg', caption = 'Samsung Customer chatbot')
